...
def get_save_width_height_depth_tensor(input_image_size, depth_pred):
  print("Type of depth_pred:", type(depth_pred))
  print("Shape of depth_pred:", depth_pred.shape)

  orig_height, orig_width = input_image_size
  depth_height, depth_width = depth_pred.shape[-2:]

  print("Inside pipe! Tensor depth_pred")
  print("Input size: {}x{}".format(orig_width, orig_height))
...
class MarigoldPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        if match_input_res:
            depth_pred = resize(
                depth_pred,
                get_save_width_height_depth_tensor(input_size[-2:], depth_pred),
